...
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex items-center relative bg-gradient-to-br from-blue-50 via-white to-green-50">
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-10 md:mb-0">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              <span className="text-brand-blue">Sahal</span> 
            ...
            <p className="text-lg text-gray-700 mb-8 border-l-4 border-brand-orange pl-4 py-2 bg-orange-50 rounded-r-md">
              Led by <span className="font-semibold text-brand-dark-blue">Dr. Andrew</span>, 
              <span className="block mt-1">Specialist in Reproductive Health</span>
            </p>
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
              <a 
                href="#booking" 
                className="px-6 py-3 bg-brand-green text-white rounded-lg hover:bg-brand-dark-green transition duration-300 shadow-lg text-center sm:text-left font-medium"
              >
                Book Appointment
              </a>
              <a 
                href="#services" 
                className="px-6 py-3 border-2 border-brand-orange text-brand-dark-orange rounded-lg hover:bg-orange-50 transition duration-300 text-center sm:text-left font-medium"
              >
                Our Services
              </a>
            </div>
          ...
          <div className="md:w-1/2 flex justify-center">
            <div className="relative w-full max-w-md">
              ...
              <div className="p-1 rounded-lg bg-gradient-to-br from-brand-blue via-brand-green to-brand-orange">
                <div className="aspect-w-16 aspect-h-9 bg-white rounded-lg shadow-xl flex items-center justify-center overflow-hidden">
                  <div className="text-center p-8 relative z-10 bg-gray-50 bg-opacity-90 w-full h-full flex flex-col items-center justify-center">
